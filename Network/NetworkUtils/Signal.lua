...
const function acquireRunnerThreadAndCallEventHandler(fn, ...)
...
-- them with.
const function runEventHandlerInFreeThread(...)
...
function Signal.new<T...>(_fn: ((...any) -> ())?): Signal<T...>
...
function Signal:DisconnectAll()
	...
	const yieldedThreads = rawget(self, "_yieldedThreads")
...
function Signal:Destroy()
	...
	const proxyHandler = rawget(self, "_proxyHandler")
